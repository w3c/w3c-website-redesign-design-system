...
// Project name
set('application', 'W3C Design System redesign - HTML prototype');

// Project repository
set('repository', 'git@github.com:w3c/w3c-website-redesign-design-system.git');
...
// Tasks
desc('W3C Design System redesign - HTML prototype');
task('local:build', function () {
    ...
    writeln('Running NPM tasks - build Apollo');

    run('npm run build-apollo');

    writeln('Build complete.');

    writeln('Running NPM tasks - build site');
